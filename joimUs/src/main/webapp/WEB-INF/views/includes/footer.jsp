...
<footer class="bg-dark text-light" style="position : relative; transform:translateY(0%); bottom : 0; width:100%;">
	<div class="container d-flex flex-wrap justify-content-between align-items-center py-3">
		...
		<ul class="nav col-md-4 justify-content-end">
			<li class="nav-item"><a href="/privacy" class="nav-link px-2 text-white">개인정보처리방침</a></li>
			<li class="nav-item"><a href="/contact" class="nav-link px-2 text-white">문의하기</a></li>
		</ul>
	</div> 
</footer>
...
<!-- <script src="/resources/js/jquery.ellipsis.min.js"></script> -->
</body>
</html>